            ...
            <div class="container py-4">
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        <a type="button" class="btn btn-outline-primary" href="students_workshop.jsp">My Workshops</a>
                    </div>
                </div>                        
...
<%
    if (request.getParameter("wrkId") != null) {
        ...
        String ursId = session.getAttribute("usrId").toString();
 
        sqlQuery = "INSERT INTO `users_workshop` (`usrworkId`, `usrId`, `wrkId`, `usrwrkRegDate`) VALUES (NULL, '"+ ursId +"', '"+ wrkId +"', CURRENT_TIMESTAMP);";
        try{
            preparedStmt = connection.prepareStatement(sqlQuery);
            preparedStmt.execute();
            %><div class="alert alert-success" role="alert">The Workshop information has been registered successfully.</div><%
...
<%
    ...
    sqlQuery = "SELECT * FROM `workshops` WHERE wrkId NOT IN (SELECT wrkId FROM users_workshop WHERE users_workshop.usrId = '"+ usrId +"') ORDER BY wrkId DESC;";
    try{
        preparedStmt = connection.prepareStatement(sqlQuery);
            ...
            <tr>
              ...
              <td>
                    <div class="btn-group btn-group-sm" role="group">
                      <a type="button" class="btn btn-success" href="students.jsp?wrkId=<% out.print(resultSet.getString(1)); %>">Register</a>
                   </div>
              </td>
            </tr>        
            <% 
