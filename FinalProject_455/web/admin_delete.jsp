...
<%-- 
    ...
    Created on : Nov 4, 2022, 11:37:33 AM
    Author     : afnan
--%>
                ...
                <div class="row justify-content-center pt-3">                
                    <div class="card col-8 p-0 m-0">
                        <div class="card-header text-bg-danger">
                            <h2>Are you sour you want to delete this record?</h2>
                        </div>
...
<%
    ...
    if (request.getParameter("submit") != null) {
        ...
        if (request.getParameter("oldwrkId") != null) {
            ...
            sqlQuery = "DELETE FROM `workshops` WHERE `wrkId` = '"+ wrkId +"'";
            try{
                preparedStmt = connection.prepareStatement(sqlQuery);
                preparedStmt.execute();
                %><div class="alert alert-success" role="alert">The Workshop information has been deleted successfully.</div><%
...
%>                            
                            ...
                            <form action="admin_delete.jsp" method="post">
                                ...
                                <button type="submit" name="submit" value="submit" class="btn btn-danger">Yes, Delete</button>
                            </form>                
                        </div>                
